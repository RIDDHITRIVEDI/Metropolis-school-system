...
/**
 * Created by Vishmay on 12/16/2016.
 */
...
public class WebRequest {
     ...
     */
    public JSONObject makeWebServiceCall(String url, int requestmethod) {
     ...
     */
    public JSONObject makeWebServiceCall(String urladdress, int requestmethod,
