...
public class Your_mail extends Fragment {
TextView message;
    TextView from;
String cityname;
    ...
    private static String REGISTER_URL1 = "http://ridhitrivedi.16mb.com/get_message.php";
    ...
    class RegisterUser extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            CardAdapter4 ad = new CardAdapter4(getActivity(), usersList);
