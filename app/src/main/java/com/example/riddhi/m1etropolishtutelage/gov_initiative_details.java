 ...
 */
public class gov_initiative_details extends Fragment {
   ...
   // private static String url = "http://hemalleeway.16mb.com/imageget.php";
    private static String url = "http://ridhitrivedi.16mb.com/INITIATIVE.php";
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerView.Adapter adapter;

    private InfiniteIndicator mAnimLineIndicator;
    public gov_initiative_details() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      View v=inflater.inflate(R.layout.gov_initiative_details,container,false);
